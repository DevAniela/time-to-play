...
const initialFacts = [
  {
    ...
    category: "încălzire",
    objectives: ["concentrare", "detensionarea atmosferei", "matematică"],
    questions: [
  ...
  {
    id: 2,
    name: "Află pasiunile mele",
    text: "Unul dintre parteneri își alege o pasiune sau un hobby și îl ține secret. Celălalt partener trebuie să ghicească pasiunea sau hobby-ul ascuns prin intermediul unor întrebări. Persoana care își ascunde pasiunea trebuie să răspundă doar cu „da” sau „nu” la întrebările celuilalt partener.",
    category: "introspecție",
    objectives: ["comunicare", "colaborare", "conversație", "conexiune"],
    questions: [
